...
shows evidence for clustering at distances smaller than around 10 km but after that the observed values are not significantly different that those expected from a random spatial process.
...
The spatial analysis of Canada Goose occurrences in British Columbia, Canada reveals that the species is not distributed uniformly throughout the region, with most of the occurrences being in the south and southwest.  

The first moment analysis indicates that the intensity of the occurrences is spatially varying and not homogeneous, with significant deviations from complete spatial randomness.  

The second moment analysis reveals evidence of clustering tendencies in the data, suggesting that the relationship between points may be due to effects between points rather than relationships with covariates.  Further analysis shows that the occurrence of Canada Goose is related to covariates such as elevation, forest cover, human factor influence, and distance to water, with the species being more likely to occur near water and forested areas. The hot spot analysis identifies the southern region of BC as having more occurrences of Canada Goose.

Overall, the analysis is a comprehensive spatial exploration of Canada Goose occurrences in BC, using various techniques and R packages. The findings contribute to a better understanding of the spatial distribution of the species and provide insights into the factors that influence its occurrences in the region.
